...
export const config = {
  matcher: [
    '/((?!_next|api|video/|images/|favicon.ico|icon0.svg|icon1.png|apple-icon.png|manifest.json|og-image.jpg|workspace.jpg|workspace-placeholder.jpg|workspace.avif|leaf-bg.png|sitemap.xml|llms.txt).*)',
  ],
};
